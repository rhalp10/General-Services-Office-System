...
<html lang="en">
  <head>
    ...
    <title>Custodian Slip Report</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-clipboard"></i> Inventory Custodian Slip Report</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Dashboard</a></li>
						<li><i class="fa fa-clipboard"></i>Custodian Slip Report</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
            ...
            <section class="panel">
                          <header class="panel-heading tab-bg-primary ">
                              <ul class="nav nav-tabs">
                                  ...
                                  <li class="">
                                      <a data-toggle="tab" href="#office">Office</a>
                                  </li>
                                  <li class="">
                          ...
                          <div class="panel-body">
                              <div class="tab-content">
                                  <div id="name" class="tab-pane  active">
                                    ...
                                    <input class="form-control" placeholder="Search" type="text">
                                      ...
                                      <table class="table table-striped table-advance table-hover">
                                         <thead>
                                            <tr>
                                               <th><i class="icon_clipboard"></i> Full Name</th>
                                            ...
                                            <tbody>
                                              <tr>
                                                ...
                                                <td>
                                                   <div class="btn-group">
                                                  <a class="btn btn-primary" href="" title="Bootstrap 3 themes generator">View Report</a>
                                  ...
                                  <div id="office" class="tab-pane"><!--Office table content-->
                                        <table class="table table-striped table-advance table-hover">
                                         <thead>
                                            <tr>
                                               <th><i class="icon_clipboard"></i> Office Name</th>
                                  ...
                                  <div id="profile" class="tab-pane">Office</div>
                                  <div id="contact" class="tab-pane">General</div>
                              </div>
                          </div>
                      </section>
              <!-- page end-->
