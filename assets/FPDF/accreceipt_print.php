...
$row1 = mysql_fetch_array($res1);
    ...
    $pdf->Cell(0,-25,'RENATO A. ABUTAN',0,1,'C');//Name Connected to employeelist(GSO Employeelist Tree Admin to Simple Employee)
    $pdf->Cell(0,35,'Provincial Administrator',0,1,'C');
    $pdf->SetFont('Times','B',10);
    $pdf->Cell(100,-15,'Received from:',0,0,'L');
    $pdf->Cell(0,-15,'Received by:',0,1,'L');
    $pdf->SetFont('Times','U',10);
    $pdf->Cell(100,30,$row1['ReceivedFrom_Name'],0,0,'C');
    $pdf->Cell(0,30,$row1['ReceivedBy_Name'],0,1,'C');
    $pdf->SetFont('Times','B',10);
    $pdf->Cell(100,-25,'Name',0,0,'C');
    $pdf->Cell(0,-25,'Name',0,1,'C');
    $pdf->SetFont('Times','U',10);
    $pdf->Cell(100,40,$row1['ReceivedFrom_Position'],1,0,'C');
    $pdf->Cell(0,40,$row1['ReceivedBy_Position'],1,1,'C');
    $pdf->SetFont('Times','B',10);
    $pdf->Cell(100,-35,'Position',0,0,'C');
    $pdf->Cell(0,-35,'Position',0,1,'C');
    $pdf->SetFont('Times','U',10);
    $pdf->Cell(100,50,$row1['ReceivedFrom_Date'],0,0,'C');
