...
/* Database connection end */
	...
	$bincard_update_qty = $_POST['bincard_edit_qty'];
		if (  empty($bincard_update_date) || empty($bincard_update_invent_type) || empty($bincard_update_supplier) || empty($bincard_update_descrp) || empty($bincard_update_qty)) 
		{
		...
		else
		{
			...
			$sql.=" SET bin_Date = '$bincard_update_date',Supplier = 'bincard_update_supplier',Descrp = 'bincard_update_descrp',Qty = 'bincard_update_qty',InventCode = 'bincard_update_invent_type'  WHERE  ID ='$ID'";
