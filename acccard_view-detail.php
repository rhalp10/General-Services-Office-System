...
$emp_pgc_record_accID = $_REQUEST['empID'];
include('db.php');
          ...
          <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-user-md"></i><a href="acccard_view.php?accID=<?php echo $emp_pgc_record_accID;?>">PGC Accountability Card  View Set</a></li>
                        <li><i class="fa fa-user-md"></i>PGC Accountability Card View Parts of Set</li>
                          ...
                          <div class="panel-body">
                            ...
                            <div class="col-lg-10 col-sm-09 follow-info">
                                <a href="" class="btn btn-success" data-toggle="modal" data-target="#AddItem" ><span class="fa fa-plus-circle"></span> Add Item</a>
                                        ...
                                        <a class="btn btn-info pull-right" href="assets/fpdf/acccard_person_report.php?accID=<?php echo $emp_pgc_record_accID ?>" title="Print" target="_blank"><span class="icon_printer"></span> PRINT</a>
                          </div>
                    </div>
          ...
          <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="acccard_edit-detail-edit.php?accID=<?php echo $accID;?>&empID=<?php echo $emp_pgc_record_accID;?>&set=<?php echo $row['ItemSetID']; ?>&ID=<?php echo $ID;?>">Edit</a></li>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Delete Part of Set</h4>
                </div>
                <div class="modal-body">
                <center>
                <h1>Are you sure ?</h1>
                  <a class="btn btn-success" href="acccard_view-detail-delete.php?accID=<?php echo $accID;?>&ID=<?php echo $ID;?>&empID=<?php echo $emp_pgc_record_accID;?>">DELETE</a>
        ...
        <div class="row">
          <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                     <form action="acccard_view_add_par-set_action.php?accID=<?php echo $accID;?>&empID=<?php echo $emp_pgc_record_accID;?>&set=<?php echo $row['ItemSetID']; ?>" method="post" name="form1">
                     <table class="table table-striped table-advance table-hover">
                        ...
                        <div class="col-sm-offset-4">
                           <input class="btn btn-success col-sm-2" type="submit" name="SubmitPart" value="Submit"><span class="col-sm-1"></span><input class="btn btn-danger col-sm-2" type="button" name="Cancel" value="Cancel" data-dismiss="modal">
                           </div>
                    </form></div>
                </section>
            </div>
